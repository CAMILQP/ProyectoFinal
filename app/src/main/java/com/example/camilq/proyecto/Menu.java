...
public class Menu extends AppCompatActivity {
    ...
    Spinner spinnerbienetaryegresados;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerbienetaryegresados = (Spinner) findViewById(R.id.spinnerBienestarYEgresados);
        ...
        arrayAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerbienetaryegresados.setAdapter(arrayAdapter5);

        spinnerbienetaryegresados.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent RepresnetantesEstudiantiles = new Intent(Menu.this, RepresentantesEstudiantiles.class);
                        startActivity(RepresnetantesEstudiantiles);
                        break;
                    case 3:
